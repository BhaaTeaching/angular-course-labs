...
export class GalleryComponent implements OnInit {
  imageUrl: string = 'https://cdn.pixabay.com/photo/2018/08/14/13/23/ocean-3605547_960_720.jpg';
  imagesUrl: string[] = [
  ...
  constructor() {
    setInterval(() => {
      const newIndex = Math.random() * this.imagesUrl.length;
      this.imageUrl = this.imagesUrl[Math.floor(newIndex)]
    }, 3000)
  }
